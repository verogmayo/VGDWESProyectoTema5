...
<head>
    ...
    <title>Véro Grué - ProyectoTema5 CreaDBVGDWESProyectoTema5</title>
    <link rel="stylesheet" href="../webroot/css/styleEjercicios.css">
</head>
<body>
    <header class="header">
         <a href="../indexProyectoTema5.php">volver</a>
        <h1>Muestra CreaDBVGDWESProyectoTema5</h1>
    </header>
    <main>
        <section>
            <?php 
     highlight_file('../scriptDB/CreaDBVGDWESProyectoTema5.sql');
    ?>
        </section>
