...
<head>
    ...
    <title>Véro Grué - ProyectoTema5 muestraBorraDBVGDWESProyectoTema5</title>
    <link rel="stylesheet" href="../webroot/css/styleEjercicios.css">
</head>
<body>
    <header class="header">
         <a href="../indexProyectoTema5.php">volver</a>
        <h1>Muestra muestraBorraDBVGDWESProyectoTema5</h1>
    </header>
    <main>
        <section>
            <?php 
     highlight_file('../scriptDB/BDVGDWESProyectoTema5.sql');
    ?>
        </section>
    </main>
    <footer class="footer">
